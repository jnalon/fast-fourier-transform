...
def recursive_fft(x):
    ...
    implementation uses native Python lists.
...
####################################################################################################
# Recursive FFT, using NumPy arrays:
...
if __name__ == "__main__":
    ...
    print("+---------"*8 + "+")
    print("|    N    |   N^2   | Direct  | ADirect | Recurs. | ARecur. | VecRec. | Intern. |")
    print("+---------"*8 + "+")
    ...
    for n in SIZES:
        ...
        adtime = time_it(array_direct_ft, n, REPEAT)
        ...
        # Print the results:
        print(f'| {n:7} | {n**2:7} ' \
              f'| {dtime:7.4f} | {adtime:7.4f} | {rtime:7.4f} | {artime:7.4f} | {vtime:7.4f} | {intime:7.4f} |')
